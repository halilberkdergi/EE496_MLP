...
def part2Plots(results, save_dir='', filename='', show_plot=True):
    ...
    >>> part2Plots(results, save_dir='some\location\to\save', filename='part2Plots')
...
def part3Plots(results, save_dir='', filename='', show_plot=True):
    ...
    >>> part3Plots(results, save_dir='some\location\to\save', filename='part3Plots')
...
def part4Plots(result, save_dir='', filename='', show_plot=True):
    """plots multiple performance curves from multiple training results and
    saves the resultant plot as a png image
    ...
    >>> part4Plots(result, save_dir='some\location\to\save', filename='part3Plots')
...
def visualizeWeights(weights, save_dir, filename='weigths'):
    ...
    Example:
    --------
    visualizing weights at the input layer of a MLPClassifier object

    # assume classifier is an instance of MLPClassifier
